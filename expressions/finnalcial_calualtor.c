...
int main(void) {
    ...
    float percent_of_rent, percent_of_utilities, percent_of_groceries, percent_of_transportation, percent_of_savings, percent_of_spending;
    ...
    percent_of_savings = (savings / income) * 100;
