// Alan De Lara, Expressions Practice - C

#include <stdio.h>  
#include <math.h>

int var_one = 7-24/8*4+6;
int var_two = 18/3-7+2*5;
int var_three = 6*4/12+72/8-9;
int var_four = (17 - 6 / 2) + 4 * 3;
...
int var_nine = (22 / 2 - 2 * 5) pow(2) + (4 - 6 / 6) pow(2);
int main(void) {  
